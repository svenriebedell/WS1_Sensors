# Returns value for SafeBIOS BIOSVerification
# Return Type: String
...
<#
.Synopsis
   This PowerShell is using Microsoft Event for control Dell SafeBIOS Security Assessment. Select Value for SafeBIOS BIOSVerification.
...
$OutputStatement = $Safe_BIOSVerify_Value
