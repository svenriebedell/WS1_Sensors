# Returns value for SafeBIOS Score
# Return Type: String
...
<#
.Synopsis
   This PowerShell is using Microsoft Event for control Dell SafeBIOS Security Assessment. Select Value for SafeBIOS Score.
...
$OutputStatement = $Safe_Score_Value
