# Returns value for SafeBIOS TPM
# Return Type: String
...
<#
.Synopsis
   This PowerShell is using Microsoft Event for control Dell SafeBIOS Security Assessment. Select Value for SafeBIOS TPM.
...
$OutputStatement = $Safe_TPM+$Safe_TPM_Value
