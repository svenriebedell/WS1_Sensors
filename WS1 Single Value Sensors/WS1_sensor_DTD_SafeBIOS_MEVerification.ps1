# Returns value for SafeBIOS MEVerification
# Return Type: String
...
<#
.Synopsis
   This PowerShell is using Microsoft Event for control Dell SafeBIOS Security Assessment. Select Value for SafeBIOS MEVerification.
...
$OutputStatement = $Safe_MEVerify_Value
