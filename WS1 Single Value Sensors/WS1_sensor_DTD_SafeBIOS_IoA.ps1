# Returns value for SafeBIOS IoA
# Return Type: String
...
<#
.Synopsis
   This PowerShell is using Microsoft Event for control Dell SafeBIOS Security Assessment. Select Value for SafeBIOS IoA.
...
$OutputStatement = $Safe_IOA_Value
