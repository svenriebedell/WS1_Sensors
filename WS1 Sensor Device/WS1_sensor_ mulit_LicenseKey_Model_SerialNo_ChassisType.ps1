...
.DESCRIPTION
   Powershell using WMI for for collecting Device Informations and build a info-string for using in Workspace One Intelligence later. This Script need to be imported in Device / Sensor section in Workspace One UEM. This File is for collecting datas only and has no other automations.
#>
