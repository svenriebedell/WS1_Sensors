# Returns value for CPU Architectur, CPUStatus, DataWidth, Family, Manufacturer, Name, NumberofCores, NumberofEnabledCore, NumberofLogicalProcessors
# Return Type: String
...
<#
.Synopsis
   This PowerShell is using WMI to collect values from Win32_Processor. Select Value for CPU Architectur, CPUStatus, DataWidth, Family, Manufacturer, Name, NumberofCores, NumberofEnabledCore, NumberofLogicalProcessors
...
$CPU_Family_Value = switch ($CPU_Family_Value)
   {
        1	{"Other"}
        2	{"Unknown"}
        3	{"8086"}
