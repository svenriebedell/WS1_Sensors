# Returns value for RAM SerialNumber, PartNumber, Speed
# Return Type: String
...
<#
.Synopsis
   This PowerShell is using WMI to collect values from Win32_PhysicalMemory. Select Value for RAM SerialNumber, PartNumber, Speed
...
$RAM_PartNumber = "Part Number: "
$RAM_SerialNumber = "CPU Architecture: "
